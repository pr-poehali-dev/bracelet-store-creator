...
export const STONES_CATALOG = [
  { id: "amethyst", name: "Аметист", color: "#9b59b6", meaning: "Гармония, спокойствие, интуиция", price: 56 },
  { id: "rose_quartz", name: "Розовый кварц", color: "#f4a7b9", meaning: "Любовь, нежность, сострадание", price: 46 },
  { id: "tiger_eye", name: "Тигровый глаз", color: "#b8860b", meaning: "Уверенность, защита, воля", price: 52 },
  { id: "lapis", name: "Лазурит", color: "#1a5276", meaning: "Мудрость, правда, ясность", price: 66 },
  { id: "turquoise", name: "Бирюза", color: "#48c9b0", meaning: "Успех, удача, коммуникация", price: 62 },
  { id: "malachite", name: "Малахит", color: "#27ae60", meaning: "Трансформация, рост, защита", price: 58 },
  { id: "obsidian", name: "Обсидиан", color: "#2c2c2c", meaning: "Защита, очищение, сила", price: 46 },
  { id: "citrine", name: "Цитрин", color: "#f39c12", meaning: "Радость, процветание, творчество", price: 54 },
  { id: "labradorite", name: "Лабрадорит", color: "#5d6d7e", meaning: "Магия, интуиция, трансформация", price: 64 },
  { id: "carnelian", name: "Сердолик", color: "#e74c3c", meaning: "Энергия, мотивация, смелость", price: 50 },
  { id: "jade", name: "Нефрит", color: "#45b39d", meaning: "Удача, мир, долголетие", price: 60 },
  { id: "hematite", name: "Гематит", color: "#616161", meaning: "Заземление, баланс, стабильность", price: 46 },
  { id: "moonstone", name: "Лунный камень", color: "#d5d8dc", meaning: "Интуиция, женственность, цикличность", price: 66 },
  { id: "amber", name: "Янтарь", color: "#d4ac0d", meaning: "Тепло, очищение, радость", price: 58 },
  { id: "coral", name: "Коралл", color: "#e8825a", meaning: "Жизненная сила, защита, радость", price: 54 },
  { id: "pearl", name: "Жемчуг", color: "#f0ead6", meaning: "Чистота, мудрость, женственность", price: 62 },
];