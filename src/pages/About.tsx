...
const TEAM = [
  { name: "Тетюшева Лидия Владимировна", role: "Основатель", text: "10 лет работаю с камнями. Каждый браслет — это моя медитация и любовь." },
  { name: "Иванова Ангелина Андреевна", role: "Вдохновитель и мастер", text: "Работаю с тонкими техниками плетения и нестандартными сочетаниями камней." },
];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground font-body leading-relaxed mb-4">
                Мы создаём индивидуальные браслеты и другие украшения из натуральных камней и свечи из чистого пчелиного воска — простые вещи, которые помогают замедлиться, почувствовать себя и вернуть фокус на главное.
              </p>
              <p className="text-muted-foreground font-body leading-relaxed mb-4">
                Каждый браслет — это тактильное напоминание о балансе и внутренней опоре. Каждая свеча — это уют, тепло и возможность выдохнуть после насыщенного дня.
              </p>
              <p className="text-muted-foreground font-body leading-relaxed">
                Только природа, качество и внимание к деталям. Для тех, кто ценит искренность, комфорт и моменты тишины.
              </p>
            </div>
            <div>
              <img
