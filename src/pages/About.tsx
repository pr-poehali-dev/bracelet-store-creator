          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground font-body leading-relaxed mb-4">
                Земля & Камень родился в 2019 году из страсти к минералам и желания делать украшения, которые несут смысл. Мы верим, что каждый камень выбирает своего человека.
              </p>
